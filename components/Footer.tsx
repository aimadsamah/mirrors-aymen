      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          <div className="sm:col-span-2 md:col-span-1">
            <h3 className="text-lg sm:text-xl font-bold gold-text-gradient mb-3 sm:mb-4">
              Mirrors by Aymen
            </h3>
            <p className="text-charcoal-400 text-xs sm:text-sm leading-relaxed">
              Des miroirs personnalisés premium qui transforment chaque selfie
              en publicité gratuite pour votre business.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <Link
                href="#accueil"
                className="block text-charcoal-400 hover:text-gold-400 transition-colors text-xs sm:text-sm"
              >
                Accueil
              </Link>
              <Link
        ...
        <div className="border-t border-charcoal-800 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-charcoal-500 text-xs sm:text-sm">
          <p>
            &copy; {new Date().getFullYear()} Mirrors by Aymen. Tous droits
            réservés.
            <br />
            Conception et développement par Aimad.S
          </p>
        </div>
      </div>
    </footer>
